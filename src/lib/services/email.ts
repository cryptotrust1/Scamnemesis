        ...
        <div class="container">
          ...
          <div class="content">
            ...
            ${verificationUrl ? `
              ...
              <p><a href="${verificationUrl}" class="button">Overiť email</a></p>
            ` : ''}
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center; margin: 30px 0;">
              <a href="${verificationUrl}" class="button">Overiť email</a>
            </p>
...
${SITE_NAME}
  ...
  newReportNotification: (reportId: string, reportTitle: string, fraudType: string) => ({
    subject: `Nové hlásenie: ${reportTitle}`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="report-box">
              <h3>${reportTitle}</h3>
              <p><strong>Typ podvodu:</strong> ${fraudType}</p>
              <p><strong>ID:</strong> ${reportId}</p>
            </div>
            <p style="text-align: center;">
              <a href="${SITE_URL}/admin/reports/${reportId}" class="button">Zobraziť hlásenie</a>
            </p>
          </div>
          <div class="footer">
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="status-box">
              <p><strong>Vaše hlásenie:</strong> ${reportTitle}</p>
              <p><strong>Stav:</strong> ${status === 'approved' ? 'Schválené a zverejnené' : 'Zamietnuté'}</p>
              ${reason ? `<p><strong>Dôvod:</strong> ${reason}</p>` : ''}
            </div>
            ${status === 'approved'
