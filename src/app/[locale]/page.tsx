...
// Fraud type options for filter (all locales)
type LocaleLabels = Record<'en' | 'sk' | 'de' | 'cs', string>;
const fraudTypeOptions: Array<{ value: string; label: LocaleLabels }> = [
  { value: '', label: { en: 'All Types', sk: 'Všetky typy', de: 'Alle Typen', cs: 'Všechny typy' } },
  { value: 'INVESTMENT_FRAUD', label: { en: 'Investment Fraud', sk: 'Investičný podvod', de: 'Anlagebetrug', cs: 'Investiční podvod' } },
  { value: 'ROMANCE_SCAM', label: { en: 'Romance Scam', sk: 'Romantický podvod', de: 'Liebesbetrug', cs: 'Romantický podvod' } },
  { value: 'PHISHING', label: { en: 'Phishing', sk: 'Phishing', de: 'Phishing', cs: 'Phishing' } },
  { value: 'IDENTITY_THEFT', label: { en: 'Identity Theft', sk: 'Krádež identity', de: 'Identitätsdiebstahl', cs: 'Krádež identity' } },
  { value: 'ONLINE_SHOPPING_FRAUD', label: { en: 'E-commerce Fraud', sk: 'Internetový obchod', de: 'E-Commerce-Betrug', cs: 'E-shop podvod' } },
  { value: 'CRYPTOCURRENCY_SCAM', label: { en: 'Crypto Scam', sk: 'Krypto podvod', de: 'Krypto-Betrug', cs: 'Krypto podvod' } },
  { value: 'EMPLOYMENT_SCAM', label: { en: 'Employment Scam', sk: 'Pracovný podvod', de: 'Jobbetrug', cs: 'Pracovní podvod' } },
  { value: 'RENTAL_SCAM', label: { en: 'Rental Scam', sk: 'Prenájom podvod', de: 'Mietbetrug', cs: 'Nájemní podvod' } },
  { value: 'ADVANCE_FEE_FRAUD', label: { en: 'Advance Fee Fraud', sk: 'Poplatok vopred', de: 'Vorschussbetrug', cs: 'Poplatek předem' } },
  { value: 'FAKE_CHARITY', label: { en: 'Fake Charity', sk: 'Falošná charita', de: 'Falsche Wohltätigkeit', cs: 'Falešná charita' } },
  { value: 'TECH_SUPPORT_SCAM', label: { en: 'Tech Support Scam', sk: 'IT podpora podvod', de: 'Tech-Support-Betrug', cs: 'Tech podpora podvod' } },
  { value: 'OTHER', label: { en: 'Other', sk: 'Iné', de: 'Sonstige', cs: 'Jiné' } },
];

// Country options for filter (all locales)
const countryOptions: Array<{ value: string; label: LocaleLabels }> = [
  { value: '', label: { en: 'All Countries', sk: 'Všetky krajiny', de: 'Alle Länder', cs: 'Všechny země' } },
  { value: 'SK', label: { en: 'Slovakia', sk: 'Slovensko', de: 'Slowakei', cs: 'Slovensko' } },
  { value: 'CZ', label: { en: 'Czech Republic', sk: 'Česká republika', de: 'Tschechien', cs: 'Česká republika' } },
  { value: 'US', label: { en: 'United States', sk: 'USA', de: 'USA', cs: 'USA' } },
  { value: 'GB', label: { en: 'United Kingdom', sk: 'Veľká Británia', de: 'Großbritannien', cs: 'Velká Británie' } },
  { value: 'DE', label: { en: 'Germany', sk: 'Nemecko', de: 'Deutschland', cs: 'Německo' } },
  { value: 'AT', label: { en: 'Austria', sk: 'Rakúsko', de: 'Österreich', cs: 'Rakousko' } },
  { value: 'PL', label: { en: 'Poland', sk: 'Poľsko', de: 'Polen', cs: 'Polsko' } },
  { value: 'HU', label: { en: 'Hungary', sk: 'Maďarsko', de: 'Ungarn', cs: 'Maďarsko' } },
  { value: 'UA', label: { en: 'Ukraine', sk: 'Ukrajina', de: 'Ukraine', cs: 'Ukrajina' } },
];
  ...
  const translations = {
    ...
    de: {
      hero: {
        ...
        searchModeAutoDesc: 'Versucht zuerst exakte Übereinstimmung, dann unscharf',
        searchModeFuzzyDesc: 'Findet ähnliche Treffer (Namen, Tippfehler)',
        searchModeExactDesc: 'Nur exakte Übereinstimmungen (E-Mail, Telefon, IBAN)',
        ...
        tryFuzzy: 'Unscharfe Suche versuchen',
        reportScam: 'Betrug melden',
        noMatchingReports: 'Keine passenden Meldungen gefunden',
        tryDifferent: 'Versuchen Sie andere Suchbegriffe oder passen Sie die Filter an',
      },
      database: {
        badge: 'Echtzeitdaten',
    ...
    cs: {
      hero: {
        ...
        searchModeAuto: 'Auto',
        searchModeFuzzy: 'Podobné',
        searchModeExact: 'Přesné',
        searchModeAutoDesc: 'Nejprve přesná shoda, pak podobné',
        searchModeFuzzyDesc: 'Najde podobné shody (jména, překlepy)',
        searchModeExactDesc: 'Pouze přesné shody (e-mail, telefon, IBAN)',
        fraudType: 'Typ podvodu',
        country: 'Země',
        ...
        match: 'shoda',
        tryFuzzy: 'Zkusit podobné vyhledávání',
        reportScam: 'Nahlásit podvod',
        noMatchingReports: 'Žádná odpovídající hlášení',
        tryDifferent: 'Zkuste jiné hledané výrazy nebo upravte filtry',
      },
      database: {
