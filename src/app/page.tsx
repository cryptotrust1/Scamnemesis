  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <section className="relative py-20 sm:py-28 bg-gradient-to-b from-slate-900 to-slate-950">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="relative p-10 sm:p-14 rounded-3xl bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20 backdrop-blur-sm overflow-hidden">
              {/* Decorative Element */}
              ...
              <div className="relative z-10 text-center space-y-8">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 shadow-xl shadow-amber-500/25">
                ...
                <div className="pt-4">
                  <Link
                    href="/auth/register"
                    className="group inline-flex items-center gap-3 px-10 py-5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white text-lg font-semibold shadow-xl shadow-amber-500/25 transition-all duration-300 hover:scale-105"
                  >
                ...
                <p className="text-slate-400 text-sm">
                  In point 3 below, you will find practical instructions on how to search for and report scammers.
                </p>
              </div>
            </div>
          </div>
